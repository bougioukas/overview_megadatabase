...
The section Databases of the navigation menu includes:

1. The Overviews Database, a list of overviews of interventions, associations, DTA, etc.

2. The Methodologiacal Overviews Database, a list of methodological overviews that are used to evaluate reliability, transparency, and reporting of reviews.

3. The Guidances Database, a list of methodological papers relevant to overviews are included in the tab named "Guidance Database".
